...
mobile: MethodMobile, 
browser: opcion == '1' ? ['𝐓𝐈𝐋𝐈𝐍', 'Edge', '20.0.04'] : methodCodeQR ? ['𝐓𝐈𝐋𝐈𝐍', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
...
let prekey = []
let directorio = readdirSync("./Keroppi")
...
const directories = ['./Keroppi/', './GataJadiBot/']
